...
router.post('/',
    ...
    [
        body('isbn')
            .not().isEmpty()
            .withMessage('Please enter an ISBN')
    ]
                ...
                con.query(sql, function (err, result) {
                    ...
                    if (table_result.length === 0) {
                        ...
                        con.query(issuedBooksQuery, function (err, result) {
                            ...
                            res.render("issued_books", { booksData: r, altmsg: "You have not issued this book. Please check the ISBN" });
                        ...
                        con.query(quantityQuery, function (err, result) {
                            ...
                            var quantityUpdateQuery = `UPDATE available_books SET quantity = ${quantity + 1}
                       ...
                       WHERE av.isbn=ib.isbn
                        ...
                        con.query(sql, function (err, result) {
                            ...
                            res.render("issued_books", { booksData: r, msg: "Book returned successfully" });
                        });
